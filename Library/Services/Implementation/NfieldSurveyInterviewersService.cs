...
namespace Nfield.Services.Implementation
{
    internal class NfieldSurveyInterviewersService : INfieldSurveyInterviewersService, INfieldConnectionClientObject
    {
        ...
        public Task<IQueryable<SurveyInterviewerModel>> GetAsync(string surveyId)
        {
            ...
            return Client.GetAsync(uri)
                ...
                .ContinueWith(
                    stringTask => JsonConvert.DeserializeObject<List<SurveyInterviewerModel>>(stringTask.Result).AsQueryable())
                .FlattenExceptions();
        }
