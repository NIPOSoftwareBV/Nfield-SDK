...
namespace Nfield.SDK.Services.Implementation
{
    internal class NfieldSurveyGroupAssignmentsService : INfieldSurveyGroupAssignmentsService, INfieldConnectionClientObject
    {
        ...
        public async Task<SurveyGroupNativeAssignment> AssignLocalAsync(int surveyGroupId, NativeIdentityModel model)
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        public async Task UnassignLocalAsync(int surveyGroupId, NativeIdentityModel model)
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
