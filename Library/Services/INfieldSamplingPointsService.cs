...
namespace Nfield.Services
{
    ...
    public interface INfieldSamplingPointsService
    {
        ...
        /// <exception cref="Nfield.Exceptions.NfieldErrorException"></exception>
        /// <exception cref="Nfield.Exceptions.NfieldHttpResponseException"></exception>
        Task<SamplingPoint> ActivateAsync(string surveyId, string samplingPointId);
        ...
        /// <exception cref="Nfield.Exceptions.NfieldErrorException"></exception>
        /// <exception cref="Nfield.Exceptions.NfieldHttpResponseException"></exception>
        Task<SamplingPoint> ReplaceAsync(string surveyId, string samplingPointId, SamplingPoint samplingPoint);
